...
class AddFolderState(PartialState):
    ...
    def get_next_state(self) -> ('InterfaceState', str):
        ...
        def process_folder_name(folder_name):
            ...
            def process_drive_name(drive_name):
                ...
                return DefaultInterfaceState.DefaultInterfaceState(self._databases_list), final_message

            return PromptState(self._databases_list, process_drive_name), second_prompt


        return PromptState(self._databases_list, process_folder_name), first_prompt
